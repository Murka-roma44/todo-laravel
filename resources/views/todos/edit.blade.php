    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form method="post" action="{{ route('todos.update') }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="mb-3 form-group">
                        ...
                        <input type="text" name="keywords" class="form-control p-4" value="{{ $todo->keywords}}" data-role="tagsinput"/>
                  </div>
                  <div class="mb-3">
                    <strong>Image:</strong>
                    <input type="file" name="image" class="form-control" accept="image/png, image/jpeg, image/jpg" placeholder="image" >
                    <img src="/images/origin/{{ $todo->image }}" width="300px">
                  </div>
                  <div class="mb-3">
